...
runsession1 = RunSession.create(name: "Monday 6:00am", instructor: "Daniel", start_date: DateTime.new(2021-01-20), duration: 30, location: 8, capacity: 30, run_class_id: runclass1.id)
runsession2 = RunSession.create(name: "Monday 7:00am", instructor: "Ella", start_date: DateTime.new(2021-01-20), duration: 60, location: 4, capacity: 20, run_class_id: runclass1.id)
runsession3 = RunSession.create(name: "Monday 7:30am", instructor: "Jorja", start_date: DateTime.new(2021-01-20), duration: 30, location: 6, capacity: 30, run_class_id: runclass1.id)
runsession4 = RunSession.create(name: "Monday 8:30am", instructor: "Julian", start_date: DateTime.new(2021-01-20), duration: 60, location: 1, capacity: 30, run_class_id: runclass1.id)
runsession5 = RunSession.create(name: "Monday 9:00am", instructor: "Brent", start_date: DateTime.new(2021-01-20), duration: 30, location: 5, capacity: 30, run_class_id: runclass1.id)
runsession6 = RunSession.create(name: "Monday 3:30am", instructor: "Kevin", start_date: DateTime.new(2021-01-20), duration: 45, location: 7, capacity: 30, run_class_id: runclass1.id)
runsession7 = RunSession.create(name: "Tuesday 7:30am", instructor: "James", start_date: DateTime.new(2021-01-20), duration: 60, location: 3, capacity: 10, run_class_id: runclass1.id)
runsession8 = RunSession.create(name: "Tuesday 10:00am", instructor: "Leon", start_date: DateTime.new(2021-01-20), duration: 30, location: 4, capacity: 30, run_class_id: runclass1.id)
runsession9 = RunSession.create(name: "Tuesday 11:00am", instructor: "Chloe", start_date: DateTime.new(2021-01-20), duration: 60, location: 1, capacity: 30, run_class_id: runclass2.id)
runsession10 = RunSession.create(name: "Tuesday 3:00pm", instructor: "Justin", start_date: DateTime.new(2021-01-20), duration: 75, location: 1, capacity: 30, run_class_id: runclass2.id)
runsession11 = RunSession.create(name: "Tuesday 5:00pm", instructor: "Shawn", start_date: DateTime.new(2021-01-20), duration: 60, location: 3, capacity: 0, run_class_id: runclass3.id)
runsession12 = RunSession.create(name: "Tuesday 5:30pm", instructor: "Angelie", start_date: DateTime.new(2021-01-20), duration: 45, location: 6, capacity: 30, run_class_id: runclass3.id)
runsession13 = RunSession.create(name: "Wednesday 6:00am", instructor: "Capri", start_date: DateTime.new(2021-01-20), duration: 75, location: 2, capacity: 30, run_class_id: runclass3.id)
runsession14 = RunSession.create(name: "Wednesday 6:30am", instructor: "Carter", start_date: DateTime.new(2021-01-20), duration: 45, location: 1, capacity: 30, run_class_id: runclass3.id)
runsession15 = RunSession.create(name: "Wednesday 9:30am", instructor: "Carter", start_date: DateTime.new(2021-01-20), duration: 45, location: 1, capacity: 30, run_class_id: runclass4.id)
runsession16 = RunSession.create(name: "Wednesday 10:00am", instructor: "Carter", start_date: DateTime.new(2021-01-20), duration: 45, location: 1, capacity: 30, run_class_id: runclass4.id)
runsession17 = RunSession.create(name: "Thursday 1:00pm", instructor: "Carter", start_date: DateTime.new(2021-01-20), duration: 50, location: 1, capacity: 30, run_class_id: runclass4.id)
runsession18 = RunSession.create(name: "Thursday 4:00pm", instructor: "Kevin", start_date: DateTime.new(2021-01-20), duration: 50, location: 7, capacity: 30, run_class_id: runclass4.id)
runsession19 = RunSession.create(name: "Thursday 5:30pm", instructor: "Kevin", start_date: DateTime.new(2021-01-20), duration: 45, location: 7, capacity: 30, run_class_id: runclass4.id)
runsession20 = RunSession.create(name: "Thursday 8:00pm", instructor: "Kevin", start_date: DateTime.new(2021-01-20), duration: 45, location: 7, capacity: 30, run_class_id: runclass4.id)
