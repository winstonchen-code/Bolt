...
runclass1 = RunClass.create(level: "Bolt I", instructor: "Daniel", start_date: DateTime.new(2021,9,2,12), location: 1, duration: 60)
runclass2 = RunClass.create(level: "Bolt II", instructor: "Ella", start_date: DateTime.new(2021,10,3,14), location: 2, duration: 30)
runclass3 = RunClass.create(level: "Bolt III", instructor: "Chloe", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass4 = RunClass.create(level: "Bolt II", instructor: "Luke", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass5 = RunClass.create(level: "Bolt IV", instructor: "Ella", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass6 = RunClass.create(level: "Bolt IV", instructor: "Jorja", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass7 = RunClass.create(level: "Bolt IV", instructor: "Brent", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass8 = RunClass.create(level: "Bolt III", instructor: "Luke", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass9 = RunClass.create(level: "Bolt IV", instructor: "Chloe", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass10 = RunClass.create(level: "Bolt I", instructor: "Luke", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass11 = RunClass.create(level: "Bolt III", instructor: "Luke", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass12 = RunClass.create(level: "Bolt IV", instructor: "Jorja", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass13 = RunClass.create(level: "Bolt I", instructor: "Brent", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
runclass14 = RunClass.create(level: "Bolt III", instructor: "Luke", start_date: DateTime.new(2021,8,2,12), location: 4, duration: 60)
